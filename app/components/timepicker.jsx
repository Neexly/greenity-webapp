    ...
    <div className="grid gap-4 grid-cols-3 grid-rows-11">
      {availableSlots.map((hour) => (
        <span
          ...
          className="items-center rounded-md bg-blue-50 px-2 py-1 text-xl font-medium text-blue-700 ring-1 ring-inset ring-blue-700/10 cursor-pointer hover:bg-blue-100"
        >
          {hour}
        </span>
      ))}
